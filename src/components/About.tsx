        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            ...
            <div className="bg-dark border border-gold/30 p-6 rounded-lg hover:shadow-[0_0_15px_rgba(255,215,0,0.3)] transition-all duration-300">
              ...
              <p className="text-sm text-light/80">Гарантируем полную анонимность и защиту ваших персональных данных на всех этапах сотрудничества.</p>
            </div>
            
            <div className="bg-dark border border-gold/30 p-6 rounded-lg hover:shadow-[0_0_15px_rgba(255,215,0,0.3)] transition-all duration-300">
              <div className="text-gold text-3xl mb-4">📜</div>
              <h3 className="text-xl font-semibold mb-2">Прозрачные условия, никаких скрытых требований</h3>
              <p className="text-sm text-light/80">Все детали сотрудничества фиксируются в договоре. Мы максимально открыты и честны с нашими моделями.</p>
            </div>
          </div>
        </div>
      </div>
