...
const FAQ = () => {
  const faqItems = [
    ...
    {
      question: "Могу ли я работать удаленно из любого города?",
      answer: "Да, наша работа полностью удаленная. Вы можете сотрудничать с нами из любой точки России и других стран.",
    },
  ];
